...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Log'
        db.create_table(u'votes_log', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('candidate', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['votes.Candidate'])),
            ('number_of_votes', self.gf('django.db.models.fields.PositiveIntegerField')(default=0)),
            ('timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'votes', ['Log'])


    def backwards(self, orm):
        # Deleting model 'Log'
        db.delete_table(u'votes_log')
