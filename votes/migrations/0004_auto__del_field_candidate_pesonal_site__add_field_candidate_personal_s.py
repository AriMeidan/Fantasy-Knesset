...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Candidate.pesonal_site'
        db.delete_column(u'votes_candidate', 'pesonal_site')

        # Adding field 'Candidate.personal_site'
        db.add_column(u'votes_candidate', 'personal_site',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)


        # Changing field 'Candidate.party'
        db.alter_column(u'votes_candidate', 'party_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['votes.Party']))

    def backwards(self, orm):
        # Adding field 'Candidate.pesonal_site'
        db.add_column(u'votes_candidate', 'pesonal_site',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Candidate.personal_site'
        db.delete_column(u'votes_candidate', 'personal_site')


        # Changing field 'Candidate.party'
        db.alter_column(u'votes_candidate', 'party_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['votes.Party'], null=True))
    ...
    models = {
        ...
        u'votes.candidate': {
            ...
            'party': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['votes.Party']"}),
            'personal_site': ('django.db.models.fields.URLField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
